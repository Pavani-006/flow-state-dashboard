...
export const Route = createFileRoute("/tasks")({
  head: () => ({
    meta: [
      { title: "Tasks — Flowdesk" },
      { name: "description", content: "Manage your tasks with list and Kanban views." },
    ],
  }),
  component: TasksPage,
});
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    {items.length === 0 && (
                      <p className="px-1 text-xs text-muted-foreground">Drop tasks here</p>
                    )}
                  </div>
                </div>
              );
          ...
          {filtered.length === 0 ? (
            ...
            <div className="overflow-hidden rounded-2xl border">
              {filtered.map((t) => (
                <div
                  key={t.id}
                  className="flex items-center gap-3 border-b bg-card px-4 py-3 last:border-b-0 hover:bg-accent/30"
                >
                  <Checkbox
