...
import { LayoutDashboard, ListChecks, Timer, Target, BarChart3, Calendar, StickyNote, Sparkles } from "lucide-react";
import {
      ...
      <SidebarFooter>
        {!collapsed && (
          <div className="rounded-xl border bg-gradient-to-br from-accent/40 to-transparent p-3 text-xs">
            ...
            <p className="mt-1 text-muted-foreground">Press <kbd className="rounded bg-muted px-1.5 py-0.5 text-[10px]">⌘K</kbd> to open the command palette.</p>
          </div>
        )}
      </SidebarFooter>
    </Sidebar>
